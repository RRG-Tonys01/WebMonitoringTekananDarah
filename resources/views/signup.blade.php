    ...
    <div class="container formLogin mx-auto d-flex">
        <div class="container">
            <form>
                ...
                <div class="form-group">
                    <label for="Username" class=>Sex</label>
                    <input type="text" class="form-control" id="username" placeholder="Enter Sex">
                </div>
                <div class="form-group">
                    <label for="Password lableLogin">Birth Date</label>
                    <input type="date" class="form-control" id="username" placeholder="Enter Birth Date">
                </div>
                <div class="form-group">
